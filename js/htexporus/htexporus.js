...
const MAIN_URL = 'https://www.htexporus.ru/catalogue-2025.html';
const COMPANY_LINK_SELECTOR = '.article-content li a';
const CONTENT_SELECTOR = '.article-content';
const OUTPUT_FILENAME = 'htexporus.csv';
            ...
            try {
                ...
                if (contentBlock) {
                    ...
                    for (const p of paragraphs) {
                        ...
                        // Ищем телефон
                        if (text.includes('Телефон') && !phone) {
                        ...
                        // Ищем email
                        if ((text.includes('E-mail') || text.includes('Email')) && !email) {
                        ...
                        // Ищем сайт
                        if ((text.includes('Сайт') || text.includes('Адрес в Интернете') || text.includes('Веб-сайт')) && !site) {
